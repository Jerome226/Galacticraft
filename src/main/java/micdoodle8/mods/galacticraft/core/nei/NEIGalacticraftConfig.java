...
public class NEIGalacticraftConfig implements IConfigureNEI
{
    ...
    private void addBuggyRecipes()
    {
        ...
        input.put(3, new PositionedStack(new ItemStack(GSItems.ControlComputer, 1, 100), 62 - x, 73 - y));
        ...
        input.put(8, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1), 26 - x, 19 - y));
        input.put(9, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1), 98 - x, 19 - y));
        input.put(10, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1), 26 - x, 109 - y));
        input.put(11, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1), 98 - x, 109 - y));
        ...
        input.put(17, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 8 - x, 37 - y));
        input.put(18, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 26 - x, 37 - y));
        input.put(19, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 98 - x, 37 - y));
        input.put(20, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 116 - x, 37 - y));
        input.put(21, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 8 - x, 91 - y));
        input.put(22, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 26 - x, 91 - y));
        input.put(23, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 98 - x, 91 - y));
        input.put(24, new PositionedStack(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1), 116 - x, 91 - y));
