...
public class NEIGalacticraftConfig implements IConfigureNEI
{
    ...
    private void addBuggyRecipes()
    {
        ...
        input.put(8, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 26 - x, 19 - y));
        input.put(9, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 98 - x, 19 - y));
        input.put(10, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 26 - x, 109 - y));
        input.put(11, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 98 - x, 109 - y));
        ...
        input.put(17, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 8 - x, 37 - y));
        input.put(18, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 26 - x, 37 - y));
        input.put(19, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 98 - x, 37 - y));
        input.put(20, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 116 - x, 37 - y));
        input.put(21, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 8 - x, 91 - y));
        input.put(22, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 26 - x, 91 - y));
        input.put(23, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 98 - x, 91 - y));
        input.put(24, new PositionedStack(new ItemStack(Blocks.acacia_stairs), 116 - x, 91 - y));
