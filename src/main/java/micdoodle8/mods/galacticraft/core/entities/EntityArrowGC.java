...
public class EntityArrowGC extends Entity
{
    ...
    public EntityArrowGC(World par1World)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    }

    public EntityArrowGC(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowGC(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public EntityArrowGC(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = EntityArrowGC.causeArrowDamage(this, this);
                    }
                    else
                    {
                        var22 = EntityArrowGC.causeArrowDamage(this, this.shootingEntity);
                    }
    ...
    public static DamageSource causeArrowDamage(EntityArrowGC par0EntityArrow, Entity par1Entity)
    {
